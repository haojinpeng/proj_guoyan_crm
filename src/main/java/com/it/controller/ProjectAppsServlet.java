...
@WebServlet(name = "ProjectAppsServlet",urlPatterns = {"/projectApps.do"})
public class ProjectAppsServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("queryAll".equals(opt)) {
            ...
            // 执行 查询所有信息默认分页
            List<ProjectApp> ProjectAppsList = projectAppServices.queryAllProjectApp(pageBean,projectApp,startTime,endTime);

            System.out.println("servlet-->" + ProjectAppsList);
            ...
            //转成jsonarray
            JSONArray jsonArray = JSONArray.fromObject(ProjectAppsList);
